...
const pricing11 = [
  {
    id: 1,
    type: "Технические регламенты",
    items: [
      "Технические регламенты — ТР РФ, ТР ТС, ТР ЕАЭС (76)",
      "ГОСТ, ГОСТ Р — национальные стандарты РФ (51338)",
      "Р, ПР, РД — правила стандартизации, нормы и рекомендации в области стандартизации (1468)",
      "Общероссийские классификаторы — Общероссийские классификаторы технико-экономической и социальной информации (110)",
      "СП — своды правил (1239)",
    ],
  },
  {
    id: 2,
    type: "Документы национальной системы стандартизации",
    items: [
      "ГОСТ, ГОСТ Р — национальные стандарты РФ (51338)",
      "ГОСТ, ГОСТ Р — национальные стандарты РФ (51338)",
      "Р, ПР, РД — правила стандартизации, нормы и рекомендации в области стандартизации (1468)",
  ...
  {
    id: 3,
    type: "Стандарты Республики Беларусь",
    items: [
      "	СТБ, ГОСТ — национальные стандарты Республики Беларусь (29047)",
      "ГОСТ, ГОСТ Р — национальные стандарты РФ (51338)",
      "Р, ПР, РД — правила стандартизации, нормы и рекомендации в области стандартизации (1468)",
      "Общероссийские классификаторы — Общероссийские классификаторы технико-экономической и социальной информации (110)",
      "СП — своды правил (1239)",
  ...
  },
  {
    ...
    items: [
      "	ИСО — публикации Международной организации по стандартизации - ISO (49676)",
      "МЭК — публикации Международной электротехнической комиссии - IEC (22054)",
      "ФАО/ВОЗ — публикации CODEX ALIMENTARIUS - FAO/WHО (780)",
      "Другие — Перечень нормативных документов международных организаций по стандартизации (0)",
    ],
  },
];
const pricing1 = [
  {
    ...
    rate: 19,
    purpose: "The perfect way to get started and get used to our tools.",
    projects: 3,
    Customers: 299,
    FTP: 5,
    supportClass: "danger",
